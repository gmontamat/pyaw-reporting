...
# Copyright 2018 - Gustavo Montamat
#
...
class ReportDownloader(threading.Thread):
    ...
    def _download_report(self, max_retries=5):
        ...
        while True:
            try:
                report_downloader = self.adwords_client.GetReportDownloader(version='v201802')
                break
            except Exception as e:
        ...
        while True:
            try:
                ...
                logger.info("Successfully downloaded <{name}>".format(name=temp_name))
