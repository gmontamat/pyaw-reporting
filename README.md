...
The latest version supported by this program is [v201708](http://googleadsdeveloper.blogspot.com/2017/08/announcing-v201708-of-adwords-api.html) with [googleads 8.1.0](https://pypi.python.org/pypi/googleads). Previous versions of the API are not supported.
