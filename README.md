...
The latest version supported by this program is [v201710](http://googleadsdeveloper.blogspot.com/2017/10/announcing-v201710-of-adwords-api.html) with [googleads 9.0.0](https://pypi.python.org/pypi/googleads). Previous versions of the API are not supported.
