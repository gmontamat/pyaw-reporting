...
The latest version supported by this program is [v201609](https://googleadsdeveloper.blogspot.com/2016/10/announcing-v201609-of-adwords-api.html) with [googleads 5.2.0](https://pypi.python.org/pypi/googleads). Previous versions of the API are not supported.
